...
function BehaviorSystem:behave(dt, entity)
    ...
    table.sort(self.behaviors,
        function(a, b)
            if a.states_descriptors[a.current_state] ~= nil and b.states_descriptors[b.current_state] ~= nil then
    ...
    for i=1,  #self.behaviors do
        ...
        if behavior.states_descriptors[behavior.current_state] ~= nil then
